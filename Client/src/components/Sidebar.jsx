...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  const navItems = [
    ...
    { path: '/dashboard/complaints', label: 'Complaints', icon: 'M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
    { path: '/dashboard/ordering', label: 'Ordering', icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z' },
    { path: '/dashboard/emergency', label: 'Emergency', icon: 'M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z' },
    { path: '/dashboard/services', label: 'Services', icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
    { path: '/dashboard/rent-maintenance', label: 'Rent & Maintenance', icon: 'M12 8c-1.657 0-3 1.343-3 3v2c0 1.657 1.343 3 3 3s3-1.343 3-3v-2c0-1.657-1.343-3-3-3zm0 0v2m-9-2h18M3 12h18' },
    { path: '/dashboard/security-cams', label: 'Security Cams', icon: 'M21 10.8c0 4.4-3.6 7.8-8 7.8-4.4 0-8-3.6-8-7.8 0-4.4 3.6-7.8 8-7.8 4.4 0 8 3.6 8 7.8zm-8-6.4a6.4 6.4 0 1 1 0 12.8 6.4 6.4 0 0 1 0-12.8zm0 2.4a4 4 0 1 0 0 8 4 4 0 0 0 0-8z' },
    { path: '/dashboard/visitor-delivery', label: 'Visitor & Delivery', icon: 'M12 18c-2 0-3 1-3 3v2h6v-2c0-2-1-3-3-3zM3 14h18V8H3v6zm3-4h12v2H6v-2z' },
  ];
  useEffect(() => {
    const fn = async () => {
      try {
